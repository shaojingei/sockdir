...
#define pod_num 3
#ifdef pod_num
#define pod_productpage_ip 0x1e00f4a
#define pod_details_ip 0x1900f4a
#define pod_reviews_v3_ip 0x1d00f4a
#define pod_rating_ip 0x1a00f4a
#endif
...
{
    if (local_ip == pod_productpage_ip || pod_details_ip || pod_rating_ip || pod_reviews_v3_ip){
        return 1;
    }
    return 0;
}
