...
clang -O2 -g -target bpf -I/usr/include/linux/ -I/usr/src/linux-headers-5.0.0-42/include/ -c bpf_sockops_v4.c -o bpf_sockops_v4.o
...
clang -O2 -g -Wall -target bpf -I/usr/include/linux/ -I/usr/src/linux-headers-5.0.0-42/include/ -c bpf_tcpip_bypass.c -o bpf_tcpip_bypass.o
